...
//TextField Controller
  ...
  TextEditingController passworCtrl = TextEditingController(text: '');
              ...
              Padding(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    if (usernameCtrl.text.trim().length == 0) {
                    ...
                    } else if (passworCtrl.text.trim().length == 0) {
                      ...
                      User user = User(
                        ...
                        password: passworCtrl.text.trim(),
                      );
                      //call API
